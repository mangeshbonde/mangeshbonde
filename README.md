...
<img src="https://komarev.com/ghpvc/?username=mangeshbonde&label=Profile%20Views&color=3B82F6&style=for-the-badge" alt="Profile views" />
...
- 🌱 Expanding into **Infrastructure as Code** with Terraform and config management with Ansible
- 📫 Reach me at **connect.mangeshbonde@gmail.com**
...
|---|---------|-------------|------------|
| 🔄 | **[StaticSite CI/CD Pipeline](https://github.com/mangeshbonde/StaticSite-CI-CD-Pipeline)** | End-to-end pipeline — code commit to live K8s deployment | `Docker` `Jenkins` `Kubernetes` `Nginx` `EC2` |
| 🔒 | **[Secure Web App Delivery](https://github.com/mangeshbonde)** | Zero direct EC2 exposure using CloudFront + API Gateway | `CloudFront` `API Gateway` `Route 53` `ACM` |
| ⚡ | **[Cloud-Native To-Do App](https://github.com/mangeshbonde/to-do-app-cloud-native-with-aws-amplify)** | Serverless full-stack app with Amplify Gen 2 & Next.js | `Amplify` `Next.js` `DynamoDB` `Cognito` |
| 🌍 | **[S3 Cross-Region DR](https://github.com/mangeshbonde/Multi-Account-Disaster-Recovery-using-S3-Cross-Region-Replication)** | Multi-account disaster recovery, zero data loss | `S3` `Replication` `Multi-Account` |
| ⏰ | **[EC2 Auto Start/Stop](https://github.com/mangeshbonde/Automating-EC2-Start-Stop-Using-AWS-Lambda-Amazon-EventBridge)** | Cost optimization with scheduled Lambda automation | `Lambda` `EventBridge` `EC2` |
| 🔑 | **[IAM Region Restriction](https://github.com/mangeshbonde/Restricting-Amazon-EC2-Access-to-the-Paris-Region-eu-west-3-Using-IAM)** | Enforce least-privilege EC2 access by region | `IAM` `EC2` `Security` |
| 🔗 | **[S3 Pre-Signed URLs](https://github.com/mangeshbonde/S3-Service-Predefined-URL)** | Secure temp file access without public buckets | `S3` `Pre-Signed URL` |
| 🐳 | **[Docker To-Do App](https://github.com/mangeshbonde/docker-project-todo)** | Containerized task manager application | `Docker` `HTML` `Nginx` |
...
Mauli Group of Institutions, Shegaon
📅 2021 – 2025 | 📊 CGPA: **8.79**

**Class 12 – Science** | 72.17%
D.E.S High School & Junior College, Datala
...
### 📜 Certification
**Master in Cloud Architecture [AWS + DevOps]**
Fortune Cloud Technologies
🔖 Certificate No: FCTP2526/0433
...
### 💡 *"Infrastructure should be as easy to version and deploy as application code."*
